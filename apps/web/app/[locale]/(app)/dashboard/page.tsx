...
import { ToDoPanel } from '@/components/dashboard/to-do-panel';
...
export default function DashboardPage() {
  ...
  const showToDo =
    user.role === 'SCHOOL_ADMIN' || user.role === 'STAFF' || user.role === 'PARENT';
  const toDoItems = buildToDoItems(user.role, data);
