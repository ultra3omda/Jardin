...
/**
 * T2b — Proxy passthrough /api/discipline*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/discipline also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/discipline${suffix}${url.search}`;
