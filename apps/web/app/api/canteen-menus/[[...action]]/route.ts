...
/**
 * T2b — Proxy passthrough /api/canteen-menus*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/canteen-menus also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/canteen-menus${suffix}${url.search}`;
