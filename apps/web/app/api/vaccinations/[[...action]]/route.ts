...
/**
 * T2b — Proxy passthrough /api/vaccinations*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/vaccinations also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/vaccinations${suffix}${url.search}`;
