...
/**
 * T2b — Proxy passthrough /api/safety-drills*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/safety-drills also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/safety-drills${suffix}${url.search}`;
