...
/**
 * T2b — Proxy passthrough /api/transport-assignments*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/transport-assignments also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/transport-assignments${suffix}${url.search}`;
