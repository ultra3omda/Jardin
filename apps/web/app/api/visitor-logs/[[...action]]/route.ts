...
/**
 * T2b — Proxy passthrough /api/visitor-logs*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/visitor-logs also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/visitor-logs${suffix}${url.search}`;
