...
/**
 * T2b — Proxy passthrough /api/infirmary-visits*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/infirmary-visits also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/infirmary-visits${suffix}${url.search}`;
