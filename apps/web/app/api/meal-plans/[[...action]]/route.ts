...
/**
 * T2b — Proxy passthrough /api/meal-plans*  → NestJS API.
 * Uses [[...action]] so the base path GET /api/meal-plans also resolves.
 */
...
async function passthrough(
  ...
  const targetUrl = `${API_URL}/api/meal-plans${suffix}${url.search}`;
